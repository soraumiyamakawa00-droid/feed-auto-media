...
各 Phase の終わりに **Go / No-Go 判断ポイント**を置き、御社はいつでも降りられる構造にしています。
...
## 体制とコストの推移【要調整: 自社の実単価で作り直すこと】

| Phase | 当社体制 | 御社の工数 | 概算コスト |
|---|---|---|---|
| 0 | 2名 | 会議3回 | ¥1.5M〜 |
| 1 | 4〜5名 | 週次30分＋監修 | ¥18M〜 |
| 2 | 6〜8名 | 週次30分＋監修 | ¥30M〜 |
| 3 | 8〜10名 | 隔週＋ローンチ協業 | ¥40M〜 |
| 4 | 10名〜 | 事業判断 | 【事業計画で別途】 |

> レベニューシェア型（提案書 5-1 の A 案）を選択された場合、
> Phase 0〜2 のコストは当社負担とすることも可能です。
