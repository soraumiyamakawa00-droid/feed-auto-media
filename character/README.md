...
頭がそのまま体。手足としっぽは頭から直接生えています。
`pixel/sprite_wolf_sd*.txt`（通常・吠える・喜び・怒り・しょんぼり・寝ている）。

1頭身でかわいく見せるために効いたのは次の3つでした。

1. **顔のパーツを下half に寄せる。** 目を頭の中央より下に置く。
   上に置くと同じ絵でも一気に大人びます。
2. **足を頭に食い込ませる。** 頭の下に並べると浮いて見えるので、
   頭の輪郭より内側から生やして、頭で上を隠します。
3. **毛束は片側2つまで。** 2頭身のときは3つでしたが、
   輪郭が小さいぶん3つ以上でギザギザが勝ってしまい、丸さが消えます。

しっぽは頭の後ろだと完全に隠れるので、**右下に出して**います。
