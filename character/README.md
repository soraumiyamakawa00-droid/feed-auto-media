...
横向きより情報が少なくなるからです。なので正面は咆哮の構えにしています。

テンションを作っているのは次の3つ。この順に効きます。

1. **開いた口と牙。** 白い牙とピンクの舌。顔の中で唯一の暖色なので、真っ先に目に入る。
2. **中心に向かって下がる眉。** 眉を水平にすると途端に間抜けになる。金の目は吊り上げる。
3. **外へ跳ねた毛。** 首の毛を放射状の大きな三角3つ（片側）にして、星形のシルエットを作る。
...
| `pixel/sprite_wolf_front.txt` | 正面・咆哮 | 48×48 |
| `pixel/sprite_wolf_face.txt` | 咆哮の顔アップ（アイコン向き） | 32×32 |
