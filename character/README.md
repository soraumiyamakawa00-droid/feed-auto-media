...
![表情一覧](pixel/expressions_x6.png)

体と毛は全部共通で、**顔のパーツと耳の角度だけ**差し替えています。
...
| `pixel/sprite_wolf_front_sad.txt` | しょんぼり | 投稿スキップ・取り下げ |
| `pixel/sprite_wolf_front_sleep.txt` | 寝ている | キューが空 |

表情を分けるのに効いたのは、目の形よりも **耳の角度** でした。
耳を立てる／後ろに寝かせる／垂らす、この3つだけで感情がほぼ決まります。
顔のパーツを同じにしたまま耳だけ変えても、ちゃんと別の感情に見えます。

| 表情 | 耳 | 目 | 口 |
| --- | --- | --- | --- |
| 吠える | 立てる | 丸い金＋光 | 開けて口角を上げる |
| 通常 | 立てる | 丸い金＋光 | 閉じて口角を上げる |
| 喜び | 立てる | `^ ^` | 大きく開けて舌を出す・ほお染め |
| 怒り | 後ろに寝かせる | 細い吊り目 | 牙をむく |
| しょんぼり | 垂らす | 上まぶたを下げる | 口角を下げる・ほお染め |
| 寝ている | 少し寝かせる | 閉じる | 小さく閉じる |
